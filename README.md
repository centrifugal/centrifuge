...
Centrifuge library is a real-time core of [Centrifugo](https://github.com/centrifugal/centrifugo) server. It's also aimed to be a general purpose real-time messaging library for Go programming language. This library aims to solve several problems developer may come across when building complex real-time application:

* Scalability (scale connections over several machines)
* Proper connection management, authentication, reconnect flow and message recovery upon reconnect
* Fast, structured and lightweight client-to-server communication protocol with useful primitives
* Built-in fallback for old browsers or browsers behind strict corporate proxies
* Observability

A more concrete feature list includes:
