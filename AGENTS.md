...
2. `ReadBuffered` after reading history/stream, with the epoch read. If it reports another epoch, fail with insufficient state; otherwise merge its publications into the result.
